...
$_etiqueta->proc_etiqueta_peca_relatorio($nu_op, $co_usuario);

$xml =  simplexml_load_file("pcp_etiqueta_peca.jrxml");
$PHPJasperXML = new PHPJasperXML();
//$PHPJasperXML->debugsql=true;
$PHPJasperXML->arrayParameter=array("CO_USUARIO"=>$co_usuario);
