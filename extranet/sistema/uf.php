...
<script>
	...
	/**** INICIO CONFIGURACAO SCRIPT TABLESORTER *****/
	 ...
	 var controlsscript		=	'inc/uf_grid.php';			//Documento com o conte�do do grid em formato html
	 ...
	 var gridscript	=	'inc/uf_grid.php';					//Documento com o conte�do do grid em formato html
    ...
    <tr>
        <td>
	        <table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	              <td><img src="img/title/title_uf.jpg" width="1003" height="40" /></td>
              </tr>
              <tr>
	              <td>&nbsp;</td>
              </tr>
