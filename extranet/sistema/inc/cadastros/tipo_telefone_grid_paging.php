<?php
	...
	class Paging extends Connection{
		...
		public $s_orderby		= 'NO_TIPO_TELEFONE'; 	//Campo utilizado para ordenação inicial
		...
		public function show_table(){
			...
			$s_html .= '<script type="text/javascript" src="js/cadastros/tipo_telefone.js"></script>
						<div id="confirmaExcluirTipoTelefone"><p>Deseja realmente excluir esse registro?</p></div>
						<div id="formularioAlterarTipoTelefone"></div>';
			...
			if($this->a_columns == null){
				...
				while($row = $sth->fetch(PDO::FETCH_NUM)){
					...
					$s_html .= '<a title="Excluir" href="#" name="excluirTipoTelefone" id="'.$row[0].'"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>';
					$s_html .= '<a title="Editar" href="#" name="alterarTipoTelefone" id="'.$row[0].'"><img src="img/btn/btn_editar.gif" width="25" height="19" border="0"/></a>';
					$s_html .= '</td>';
