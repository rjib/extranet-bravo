<?php
	...
	$sqlEmail = mysql_query("SELECT PESSOA.NO_PESSOA EMPRESA
				...
				WHERE PRESTADOR.co_pessoa = '".$_GET['codigoPessoa']."'",$conexaoERP)
	or die(mysql_error());
...
$(document).ready(function(){
   ...
   $("#confirmaExcluirEmpresa").dialog({
	...
	close: function() {
	    $("#gridEmpresa").load("inc/cadastros/pessoa_alt_grid_empresa.php?codigoPessoa=<?php echo $_GET['codigoPessoa']; ?>");
	}
	});
