...
<form id="formularioAlterarAcessoConsultor" action="javascript:func()" method="post">
  <table width="100%" border="0" cellspacing="2" cellpadding="3">
		                        ...
		                        <tr>
		                          ...
		                          <td width="155" align="left"><input title="Hora Entrada" type="text" name="horaEntradaAlterar" id="horaEntradaAlterar" class="INPUT03" size="4" maxlength="5" value="<?php echo $rowAcessoConsultor['HR_ENTRADA']; ?>" disabled="disabled" /></td>
		                        ...
		                        <tr>
		                          ...
		                          <td align="left">
                                  <select title="Tipo Veiculo" name="tipoVeiculoAlterar" id="tipoVeiculoAlterar" class="SELECT01" disabled="disabled">
		                          ...
		                          <td align="left"><input title="Placa Veiculo" type="text" name="placaVeiculoAlterar" id="placaVeiculoAlterar" class="INPUT03" size="8" maxlength="8" value="<?php echo $rowAcessoConsultor['PL_VEICULO']; ?>" disabled="disabled"/></td>
    </tr>
		                        <tr>
		                          <td align="left"><font class="FONT04"><b>N&uacute;mero Cart&atilde;o:</b></font></td>
		                          <td colspan="3" align="left">
                                  <select title="Número Cartão" name="numeroCartaoAlterar" id="numeroCartaoAlterar" class="SELECT01" disabled="disabled">
		                            <option value="0">Selecione...</option>
		                            <?php
