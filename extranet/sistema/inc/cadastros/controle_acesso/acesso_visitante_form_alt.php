<?php
	...
	$sqlAcessoVisitante = mysql_query("SELECT ACESSO_VISITANTE.CO_ACESSO_VISITANTE
										   ...
										   ,CASE WHEN PESSOA.TP_PESSOA = 'F' THEN CONCAT(PESSOA_FISICA.CPF_PESSOA_FISICA, ' - ', PESSOA.NO_PESSOA) WHEN PESSOA.TP_PESSOA = 'J' THEN CONCAT(PESSOA_JURIDICA.CNPJ_PESSOA_JURIDICA, ' - ', PESSOA.NO_PESSOA) ELSE 'ERRO' END AS NOME_PESSOA
...
<form id="formularioAlterarAcessoVisitante" action="javascript:func()" method="post">
  <table width="100%" border="0" cellspacing="2" cellpadding="3">
		                        ...
		                        <tr>
		                          <td width="295" align="left"><font class="FONT04"><b>Visitante:</b></font></td>
		                        ...
		                        <tr>
		                          ...
		                          <td width="260" align="left"><input title="Hora Entrada" type="text" name="horaEntradaAlterar" id="horaEntradaAlterar" class="INPUT03" size="4" maxlength="5" value="<?php echo $rowAcessoVisitante['HR_ENTRADA']; ?>" /></td>
		                          <td width="315" align="right"><font class="FONT04"><b>Hora Saída:</b></font></td>
		                          <td width="504" align="left"><input title="Hora Saída" type="text" name="horaSaidaAlterar" id="horaSaidaAlterar" class="INPUT03" size="4" maxlength="5" value="<?php echo $rowAcessoVisitante['HR_SAIDA']; ?>" disabled="disabled"/></td>
    </tr> 
		                        <tr>
