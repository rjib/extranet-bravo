...
//$("#searching").mask("99999-999");
	/**** INICIO CONFIGURACAO SCRIPT TABLESORTER *****/
	 ...
	 var controlsscript		=	'inc/cep_grid.php';			//Documento com o conte�do do grid em formato html
	 ...
	 var gridscript	=	'inc/cep_grid.php';					//Documento com o conte�do do grid em formato html
