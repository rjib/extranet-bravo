...
<form id="formularioInserirHoraSaidaAcessoConsultor" action="javascript:func()" method="post">
  <table width="100%" border="0" cellspacing="2" cellpadding="3">
		                        ...
		                        <tr>
		                          ...
		                          <td width="155" align="left"><input title="Hora Entrada" type="text" name="horaEntrada" id="horaEntrada" class="INPUT03" size="4" maxlength="5" value="<?php echo $rowAcessoConsultor['HR_ENTRADA']; ?>" disabled="disabled" /></td>
