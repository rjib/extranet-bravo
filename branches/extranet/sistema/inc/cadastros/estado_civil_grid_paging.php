<?php
	...
	class Paging extends Connection{
		...
		public $s_orderby		= 'CO_ESTADO_CIVIL'; 	//Campo utilizado para ordenação inicial
		...
		public function show_table(){
			...
			$s_html .= '<script type="text/javascript" src="js/cadastros/estado_civil.js"></script>
						<div id="confirmaExcluirEstadoCivil"><p>Deseja realmente excluir esse registro?</p></div>
						<div id="formularioAlterarEstadoCivil"></div>';
			...
			if($this->a_columns == null){
				...
				while($row = $sth->fetch(PDO::FETCH_NUM)){
					...
					$s_html .= '<a title="Excluir" href="#" name="excluirEstadoCivil" id="'.$row[0].'"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>';
					$s_html .= '<a title="Editar" href="#" name="alterarEstadoCivil" id="'.$row[0].'"><img src="img/btn/btn_editar.gif" width="25" height="19" border="0"/></a>';
					$s_html .= '</td>';
