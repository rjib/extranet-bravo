<?php
	...
	$sqlTelefone = mysql_query("SELECT TELEFONE.CO_TELEFONE
								...
								WHERE TELEFONE.CO_PESSOA = '".$_GET['codigoPessoa']."'",$conexaoERP)
	or die(mysql_error());
...
$(document).ready(function(){
   ...
   $("#confirmaExcluirTelefone").dialog({
	...
	close: function() {
	    $("#gridTelefone").load("inc/cadastros/pessoa_alt_grid_telefone.php?codigoPessoa=<?php echo $_GET['codigoPessoa']; ?>");
	}
	});
	
	$('a[name=excluirTelefone]').click(function(e){
		e.preventDefault();
		codigoTelefone = $(this).attr("id");
...
<div id="confirmaExcluirTelefone">
	<p>Deseja realmente excluir esse registro?</p>
            ...
            <td align="center">
            <a title="Excluir" href="#" name="excluirTelefone" id="<?php echo $rowTelefone['CO_TELEFONE']; ?>"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>
            </td>
            </tr>                   
			<?php
            }
