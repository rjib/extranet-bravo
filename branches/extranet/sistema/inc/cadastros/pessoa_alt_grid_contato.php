...
$(document).ready(function(){
   ...
   $("#confirmaExcluirContato").dialog({
		...
		buttons: {
			"Sim": function() {
				$.get('inc/cadastros/pessoa_contato_ex.php', {codigoContato: codigoContato}, function(resposta) {
	...
	close: function() {
	    $("#gridContato").load("inc/cadastros/pessoa_alt_grid_contato.php?codigoPessoa=<?php echo $_GET['codigoPessoa']; ?>");
	}
	});
	
	$('a[name=excluirContato]').click(function(e){
		e.preventDefault();
		codigoContato = $(this).attr("id");
...
<div id="confirmaExcluirContato">
	<p>Deseja realmente excluir esse registro?</p>
            ...
            <td align="center">
            <a title="Excluir" href="#" name="excluirContato" id="<?php echo $rowContato['CO_CONTATO']; ?>"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>
            </td>
            </tr>                   
			<?php
            }
