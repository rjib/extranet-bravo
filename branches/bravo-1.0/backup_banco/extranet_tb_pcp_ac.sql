...
CREATE TABLE `tb_pcp_ac` (
  ...
  CONSTRAINT `FK_CO_PCP_AD_PCP_AC` FOREIGN KEY (`CO_PCP_AD`) REFERENCES `tb_pcp_ad` (`CO_PCP_AD`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=latin1 COMMENT='Tabela de arquivos .AC depois de otimizado pelo optisave';
...
INSERT INTO `tb_pcp_ac` VALUES (22,2,'2012-11-09 19:34:15');
