...
$acoes = $modulos->possuiPermissaoParaEstaArea($co_papel, CADASTROS, CADASTROS_BAIRROS);

if($acoes['NO_MODULO'] == CADASTROS_BAIRROS){
	/**
	 * Script respons�vel por listar todos os bairros cadastrados.
	 * 
    ...
    <tr>
        <td>
	        <table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	              <td><img src="img/title/title_bairro.jpg" width="1003" height="40" /></td>
              </tr>
              <tr>
	              <td>&nbsp;</td>
              </tr>
              <tr>
	              <td>
                  <div id="formularioBairro">
                            <form id="formularioBairro" action="javascript:func()" method="post">
		                    <table width="100%" border="0" cellspacing="2" cellpadding="3">
		                        <tr>
		                          <td width="72" align="left"><font class="FONT04"><b>Estado:</b></font></td>
		                          <td width="913" colspan="4" align="left"><select name="codigoEstado" id="codigoEstado" class="SELECT01" onchange="BuscaCidade(this.value);" style="width:269px">
                              ...
                              <tr>
                                  ...
                                  <select name="codigoCidade" id="codigoCidade" class="SELECT01" style="width:269px">
		                        ...
		                        <tr>
		                          ...
		                          <td colspan="4" align="left"><input title="Nome Bairro" name="nomeBairro" id="nomeBairro" type="text" class="INPUT01" size="40" maxlength="80" /></td>
	                          </tr>
	                          </table>
		                    </form>
                  </div>
                  <?php if($acoes['FL_ADICIONAR']==1){?>
                  <button type="button" id="adicionarBairro" title="Adicionar Bairro">Adicionar Bairro</button>
                  <?php }?>
                  </td>
              </tr>
              <tr>
