...
session_start();
	...
	class Paging extends Connection{
		...
		public $s_orderby		= 'BAIRRO.NO_BAIRRO'; 	//Campo utilizado para ordena��o inicial
		...
		public function show_table(){
			...
			$s_html .= '<script type="text/javascript" src="js/bairro.js"></script>
						<div id="confirmaExcluirBairro"><p>Deseja realmente excluir esse registro?</p></div>';
			...
			if($this->a_columns == null){
				...
				while($row = $sth->fetch(PDO::FETCH_NUM)){
					...
					$s_html .= '<a title="Excluir" href="#" name="excluirBairro" id="'.$row[0].'"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>';
					}
					$s_html .= '</td>';
