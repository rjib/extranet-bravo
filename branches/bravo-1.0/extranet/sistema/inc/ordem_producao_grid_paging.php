<?php
	...
	class Paging extends Connection{
		...
		public $s_orderby		= 'OP.CO_NUM'; 	//Campo utilizado para ordena��o inicial
		...
		public function show_table(){
			...
			//Formula a query			
			$sql = 'SELECT   CONCAT(OP.CO_NUM, OP.CO_ITEM, OP.CO_SEQUENCIA) NUM_OP
					...
					, OP.NU_LOTE
				FROM tb_pcp_op OP LEFT JOIN tb_pcp_produto PRODUTO
              ON OP.co_produto = PRODUTO.co_produto 
				WHERE '.$this->s_where.'
