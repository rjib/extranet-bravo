...
session_start();
	...
	class Paging extends Connection{
		...
		public $s_orderby		= 'PESSOA.NO_PESSOA'; 	//Campo utilizado para ordena��o inicial
		...
		public function show_table(){
			...
			//Formula a query
			$sql = '
				SELECT COLABORADOR.CO_COLABORADOR
				    , COLABORADOR.DT_CADAS
			...
			$s_html .= '<script type="text/javascript" src="js/cadastros/colaborador.js"></script>
						<div id="confirmaExcluirColaborador"><p>Deseja realmente excluir esse registro?</p></div>
						<div id="formularioAlterarColaborador"></div>';
			...
			if($this->a_columns == null){
				...
				while($row = $sth->fetch(PDO::FETCH_NUM)){
					...
					if($acoes['FL_EXCLUIR']==1){
						$s_html .= '<a title="Excluir" href="#" name="excluirColaborador" id="'.$row[0].'"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>';
					}
					if($acoes['FL_EDITAR']==1){
						$s_html .= '<a title="Editar" href="#" name="alterarColaborador" id="'.$row[0].'"><img src="img/btn/btn_editar.gif" width="25" height="19" border="0"/></a>';
					}
					$s_html .= '</td>';
