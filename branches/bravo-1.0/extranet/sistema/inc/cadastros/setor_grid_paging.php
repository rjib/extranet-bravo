...
session_start();
	...
	class Paging extends Connection{
		...
		public $s_orderby		= 'NO_SETOR'; 	//Campo utilizado para ordena��o inicial
		...
		public function show_table(){
			...
			$s_html .= '<script type="text/javascript" src="js/cadastros/setor.js"></script>
						<div id="confirmaExcluirSetor"><p>Deseja realmente excluir esse registro?</p></div>
						<div id="formularioAlterarSetor"></div>';
			...
			if($this->a_columns == null){
				...
				while($row = $sth->fetch(PDO::FETCH_NUM)){
					...
					$s_html .= '<a title="Excluir" href="#" name="excluirSetor" id="'.$row[0].'"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>';
					}if($acoes['FL_EDITAR']==1){
					$s_html .= '<a title="Editar" href="#" name="alterarSetor" id="'.$row[0].'"><img src="img/btn/btn_editar.gif" width="25" height="19" border="0"/></a>';
					}
					$s_html .= '</td>';
