<?php
	...
	class Paging extends Connection{
		...
		public $s_orderby		= 'NU_CARTAO_IDENTIFICACAO'; 	//Campo utilizado para ordenação inicial
		...
		public function show_table(){
			...
			$s_html .= '<script type="text/javascript" src="js/cadastros/cartao_identificacao.js"></script>
						<div id="confirmaExcluirCartaoIdentificacao"><p>Deseja realmente excluir esse registro?</p></div>
						<div id="formularioAlterarCartaoIdentificacao"></div>';
			...
			if($this->a_columns == null){
				...
				while($row = $sth->fetch(PDO::FETCH_NUM)){
					...
					$s_html .= '<a title="Excluir" href="#" name="excluirCartaoIdentificacao" id="'.$row[0].'"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>';
					$s_html .= '<a title="Editar" href="#" name="alterarCartaoIdentificacao" id="'.$row[0].'"><img src="img/btn/btn_editar.gif" width="25" height="19" border="0"/></a>';
					$s_html .= '</td>';
