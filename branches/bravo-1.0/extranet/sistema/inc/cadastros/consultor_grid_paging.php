...
session_start();
	...
	class Paging extends Connection{
		...
		public function show_table(){
			...
			$s_html .= '<script type="text/javascript" src="js/cadastros/consultor.js"></script>
						<div id="confirmaExcluirConsultor"><p>Deseja realmente excluir esse registro?</p></div>
						<div id="formularioAlterarConsultor"></div>';
			...
			if($this->a_columns == null){
				...
				while($row = $sth->fetch(PDO::FETCH_NUM)){
					...
					if($acoes['FL_EXCLUIR']==1){
						$s_html .= '<a title="Excluir" href="#" name="excluirConsultor" id="'.$row[0].'"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>';
					}
					if($acoes['FL_EDITAR']==1){
						$s_html .= '<a title="Editar" href="#" name="alterarConsultor" id="'.$row[0].'"><img src="img/btn/btn_editar.gif" width="25" height="19" border="0"/></a>';
					}
					$s_html .= '</td>';
