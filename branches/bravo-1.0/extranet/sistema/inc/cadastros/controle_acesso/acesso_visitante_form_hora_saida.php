<?php
	...
	$sqlTipoVeiculo = mysql_query("SELECT CO_TIPO_VEICULO, FL_EXIGE_PLACA, NO_TIPO_VEICULO FROM tb_tipo_veiculo ORDER BY NO_TIPO_VEICULO")
	or die("<script>
			    alert('[Erro] - Ocorreu algum erro durante a consulta, favor entrar em contato com o suporte!');
			    history.back(-1);
			</script>");
...
<form id="formularioInserirHoraSaidaAcessoVisitante" action="javascript:func()" method="post">
  <table width="100%" border="0" cellspacing="2" cellpadding="3">
		                        ...
		                        <tr>
		                          ...
		                          <td colspan="3" align="left"><input title="Visitante" name="nomeVisitante" id="nomeVisitante" type="text" class="INPUT01" size="60" maxlength="80" value="<?php echo $rowAcessoVisitante['NOME_PESSOA']; ?>" disabled="disabled"/></td>
	                          </tr>
		                        <tr>
