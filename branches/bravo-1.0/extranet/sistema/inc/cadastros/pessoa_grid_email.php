...
$(document).ready(function(){
   ...
   $("#confirmaExcluirEmail").dialog({
	...
	$('a[name=excluirContatoEmail]').click(function(e){
		e.preventDefault();
		codigoEmail = $(this).attr("rel");
...
<div id="confirmaExcluirEmail">
	<p>Deseja realmente excluir esse registro?</p>
            ...
            <td align="center">
            <a title="Excluir" href="#" name="excluirContatoEmail" rel="<?php echo $rowEmail['CO_EMAIL']; ?>"><img src="img/btn/btn_excluir.gif" width="25" height="19" border="0"/></a>
            </td>
            </tr>                   
			<?php
            }
