<?php
	...
	$paging->where('PCP_RECURSO.NO_RECURSO = "'.$searchfor.'" OR CONCAT(PCP_OP.CO_NUM, PCP_OP.CO_ITEM, PCP_OP.CO_SEQUENCIA) LIKE "%'.$searchfor.'%" AND PCP_RECURSO.FL_DELET IS NULL');
