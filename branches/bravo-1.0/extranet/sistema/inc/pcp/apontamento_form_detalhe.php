...
<script type="text/javascript" src="js/pcp/apontamento.js"></script>
  <table width="700" border="0" cellspacing="2" cellpadding="3">
    ...
    <tr>
      ...
      <td colspan="3" align="left"><select title="Recurso" name="codigoRecurso" id="codigoRecurso" class="SELECT01" style="width:250px" disabled="disabled">
        <option value="0"><?php echo $rowApontamento['NO_RECURSO']; ?></option>
      </select></td>
    </tr>
    <tr>
      <td align="left"><font class="FONT04"><b>Hora Início:</b></font></td>
      <td width="124" align="left"><input title="Hora Início" type="text" name="horaInicio" id="horaInicio" class="INPUT03" size="4" maxlength="4" value="<?php echo $rowApontamento['HR_INICIO']; ?>" disabled="disabled" /></td>
      <td width="106" rowspan="2" align="left"><font class="FONT04"><b>Tipo Apontamento:</b></font></td>
      <td width="330" rowspan="2" align="left"><input title="Tipo Apontamento" type="radio" name="flagApontamentoParada" id="flagApontamento2" value="1" <?php if($rowApontamento['FL_APONTAMENTO'] == "1"){echo "checked='checked'"; } ?> disabled="disabled"/>
        Parada de Máquina
