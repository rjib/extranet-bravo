...
CREATE TABLE `tb_pcp_ad` (
  `CO_PCP_AD` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codigo pcp do ad (Primary Key).',
  `DT_CADAS` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data e Hora cadastro do ad.',
  `NO_PCP_AD` int(5) NOT NULL DEFAULT '0' COMMENT 'Nome do arquivo ad.',
  `UN_COMPLEMENTAR` int(1) NOT NULL,
  PRIMARY KEY (`CO_PCP_AD`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=latin1 COMMENT='Tabela de arquivos .AD antes da optisave.';
...
INSERT INTO `tb_pcp_ad` VALUES (43,'2012-12-03 12:08:37',2,5),(44,'2012-12-03 12:14:03',3,5),(45,'2012-12-03 12:35:16',4,5);
...
-- Dump completed on 2012-12-03 13:23:14
