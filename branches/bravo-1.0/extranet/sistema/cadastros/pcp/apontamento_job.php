...
$(function($) {  
	...
	$("#formularioApontamentoJob").submit(function() {
		...
		$.post('inc/pcp/apontamento_ins.php', {dataApontamento: dataApontamento, codigoRecurso: codigoRecurso, horaInicioInserir: horaInicioInserir, flagApontamento: flagApontamento}, function(resposta) {
